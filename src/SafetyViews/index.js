...
export function IIHS_top_safety(iihs_input) {
...
export function IIHS_FRMO(iihs_input) {
...
export function IIHS_FRSO(iihs_input) {
...
export function IIHS_FRSOP(iihs_input) {
...
export function IIHS_SR(iihs_input) {
...
//Renders the proper information assciated with the IIHS Side Test test
export function IIHS_Rollover(iihs_input) {
...
//Renders the proper information assciated with the IIHS Side Test test
export function IIHS_Rear(iihs_input) {
...
//Renders the proper information assciated with the IIHS Side Test test
export function IIHS_FCPR(iihs_input) {
...
export function NHTSA(nhtsa_input) {
	...
	return (
		<div className='NHTSA-ratings'>
			<h4 className='heading'>NHTSA Crash Test Ratings:</h4>
			<div className='card-layout'>
				{overallRating}
			</div>
			<div className='card-layout'>
